...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 10-06-2023 a las 20:44:03
...
CREATE TABLE `alojamientos` (
  ...
  `condicion_alojamiento` enum('Propio','Alquilado') NOT NULL,
...
--
-- Estructura de tabla para la tabla `bombonas`
--

CREATE TABLE `bombonas` (
  `id_bombonas` int(11) NOT NULL,
  `proveedor` enum('Servigas','Aragas') NOT NULL,
  `litros` enum('10 Litros','18  Litros','27 Litros','43 Litros') NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;

-- --------------------------------------------------------

--
-- Estructura de tabla para la tabla `bombona_to_habitante`
--

CREATE TABLE `bombona_to_habitante` (
  `id_ bombona_to_habitante` int(11) NOT NULL,
...
CREATE TABLE `casas` (
  ...
  `n_residentes` int(30) NOT NULL,
  `color` text NOT NULL,
  `n_casa` varchar(20) NOT NULL,
  `n_baños` int(20) NOT NULL,
  `t_estructura` text NOT NULL,
  `t_techo` text NOT NULL,
  `n_habitaciones` int(20) NOT NULL,
...
--
-- Estructura de tabla para la tabla `casas_to_estados`
--

CREATE TABLE `casas_to_estados` (
...
--
-- Estructura de tabla para la tabla `casa_to_servicios`
--

CREATE TABLE `casa_to_servicios` (
  `casa_to_servicios` int(11) NOT NULL,
  `id_casa` int(11) NOT NULL,
...
CREATE TABLE `habitantes` (
  ...
  `telefono_movil` float NOT NULL,
  `n_casa` varchar(10) NOT NULL,
  `edad` int(3) NOT NULL,
  `fecha_nacimiento` date DEFAULT current_timestamp(),
  `fecha_deceso` date DEFAULT current_timestamp()
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;

-- --------------------------------------------------------

--
-- Estructura de tabla para la tabla `habitantes_to_casa`
--

CREATE TABLE `habitantes_to_casa` (
  `habitantes_to_casa` int(11) NOT NULL,
  `id_habitantes` int(11) NOT NULL,
  `id_casa` int(11) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
--
-- Estructura de tabla para la tabla `habitantes_to_nucleo_f`
--

CREATE TABLE `habitantes_to_nucleo_f` (
  `habitantes_to_nucleo_f` int(11) NOT NULL,
  `nucleo_f` int(11) NOT NULL,
  `id_habitantes` int(11) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
--
-- Estructura de tabla para la tabla `nucleo familiar`
--

CREATE TABLE `nucleo familiar` (
  `nucleo_f` int(11) NOT NULL,
...
CREATE TABLE `pedidos` (
  ...
  `id_habitantes` int(11) NOT NULL,
  `id_bombona_to_habitante` int(11) NOT NULL,
  `fecha_solicitud` date DEFAULT current_timestamp(),
  `fecha_despacho` date NOT NULL DEFAULT current_timestamp(),
...
CREATE TABLE `usuarios` (
  ...
  `nivel_usuario` enum('habitante','JefeUbch','LiderComunal','JefeDeCalle') NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;

-- --------------------------------------------------------

--
-- Estructura de tabla para la tabla `usuario_to_habitante`
--

CREATE TABLE `usuario_to_habitante` (
  `id_usuario_to_habitante` int(11) NOT NULL,
  `id_usuarios` int(11) NOT NULL,
  `id_habitantes` int(11) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
--
-- Indices de la tabla `bombonas`
--
ALTER TABLE `bombonas`
  ADD PRIMARY KEY (`id_bombonas`);

--
-- Indices de la tabla `bombona_to_habitante`
--
ALTER TABLE `bombona_to_habitante`
  ADD PRIMARY KEY (`id_ bombona_to_habitante`),
  ADD KEY `ID_Habitantes` (`id_habitantes`),
  ADD KEY `id_bombonas` (`id_bombonas`);
...
--
-- Indices de la tabla `casas_to_estados`
--
ALTER TABLE `casas_to_estados`
...
--
-- Indices de la tabla `casa_to_servicios`
--
ALTER TABLE `casa_to_servicios`
  ADD PRIMARY KEY (`casa_to_servicios`),
  ADD KEY `id_casa` (`id_casa`),
...
--
-- Indices de la tabla `habitantes_to_casa`
--
ALTER TABLE `habitantes_to_casa`
  ADD PRIMARY KEY (`habitantes_to_casa`),
  ADD KEY `id_habitantes` (`id_habitantes`),
  ADD KEY `id_casa` (`id_casa`);

--
-- Indices de la tabla `habitantes_to_nucleo_f`
--
ALTER TABLE `habitantes_to_nucleo_f`
  ADD PRIMARY KEY (`habitantes_to_nucleo_f`),
  ADD KEY `nucleo_f` (`nucleo_f`),
  ADD KEY `id_habitantes` (`id_habitantes`);
...
--
-- Indices de la tabla `nucleo familiar`
--
ALTER TABLE `nucleo familiar`
  ADD PRIMARY KEY (`nucleo_f`);
...
ALTER TABLE `pedidos`
  ...
  ADD KEY `id_bombona_to_habitante` (`id_bombona_to_habitante`),
  ADD KEY `id_habitantes` (`id_habitantes`);
...
--
-- Indices de la tabla `usuario_to_habitante`
--
ALTER TABLE `usuario_to_habitante`
  ADD PRIMARY KEY (`id_usuario_to_habitante`),
...
--
-- AUTO_INCREMENT de la tabla `bombonas`
--
ALTER TABLE `bombonas`
  MODIFY `id_bombonas` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;

--
-- AUTO_INCREMENT de la tabla `bombona_to_habitante`
--
ALTER TABLE `bombona_to_habitante`
  MODIFY `id_ bombona_to_habitante` int(11) NOT NULL AUTO_INCREMENT;
...
--
-- AUTO_INCREMENT de la tabla `casas_to_estados`
--
ALTER TABLE `casas_to_estados`
  MODIFY `id_direccion` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT de la tabla `casa_to_servicios`
--
ALTER TABLE `casa_to_servicios`
  MODIFY `casa_to_servicios` int(11) NOT NULL AUTO_INCREMENT;
...
--
ALTER TABLE `habitantes`
  MODIFY `id_habitantes` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;

--
-- AUTO_INCREMENT de la tabla `habitantes_to_casa`
--
ALTER TABLE `habitantes_to_casa`
  MODIFY `habitantes_to_casa` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT de la tabla `habitantes_to_nucleo_f`
--
ALTER TABLE `habitantes_to_nucleo_f`
  MODIFY `habitantes_to_nucleo_f` int(11) NOT NULL AUTO_INCREMENT;
...
--
-- AUTO_INCREMENT de la tabla `nucleo familiar`
--
ALTER TABLE `nucleo familiar`
  MODIFY `nucleo_f` int(11) NOT NULL AUTO_INCREMENT;
...
--
-- AUTO_INCREMENT de la tabla `usuario_to_habitante`
--
ALTER TABLE `usuario_to_habitante`
  MODIFY `id_usuario_to_habitante` int(11) NOT NULL AUTO_INCREMENT;
...
--
ALTER TABLE `alojamientos`
  ADD CONSTRAINT `alojamientos_ibfk_1` FOREIGN KEY (`id_alojamiento`) REFERENCES `casas` (`id_casa`) ON UPDATE CASCADE;

--
-- Filtros para la tabla `bombona_to_habitante`
--
ALTER TABLE `bombona_to_habitante`
  ADD CONSTRAINT `bombona_to_habitante_ibfk_1` FOREIGN KEY (`id_bombonas`) REFERENCES `bombonas` (`id_bombonas`) ON UPDATE CASCADE,
  ADD CONSTRAINT `bombona_to_habitante_ibfk_2` FOREIGN KEY (`id_habitantes`) REFERENCES `habitantes` (`id_habitantes`) ON UPDATE CASCADE,
  ADD CONSTRAINT `bombona_to_habitante_ibfk_3` FOREIGN KEY (`id_ bombona_to_habitante`) REFERENCES `pedidos` (`id_bombona_to_habitante`) ON DELETE NO ACTION ON UPDATE NO ACTION;

--
-- Filtros para la tabla `casas`
--
ALTER TABLE `casas`
  ADD CONSTRAINT `casas_ibfk_1` FOREIGN KEY (`id_casa`) REFERENCES `habitantes_to_casa` (`habitantes_to_casa`) ON UPDATE CASCADE;

--
-- Filtros para la tabla `casas_to_estados`
--
ALTER TABLE `casas_to_estados`
  ADD CONSTRAINT `casas_to_estados_ibfk_1` FOREIGN KEY (`id_habitantes`) REFERENCES `habitantes` (`id_habitantes`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  ADD CONSTRAINT `casas_to_estados_ibfk_2` FOREIGN KEY (`id_casa`) REFERENCES `casas` (`id_casa`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  ADD CONSTRAINT `casas_to_estados_ibfk_3` FOREIGN KEY (`id_ciudad`) REFERENCES `ciudades` (`id_ciudad`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  ADD CONSTRAINT `casas_to_estados_ibfk_4` FOREIGN KEY (`id_estado`) REFERENCES `estados` (`id_estado`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  ADD CONSTRAINT `casas_to_estados_ibfk_5` FOREIGN KEY (`id_municipio`) REFERENCES `municipios` (`id_municipio`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  ADD CONSTRAINT `casas_to_estados_ibfk_6` FOREIGN KEY (`id_parroquia`) REFERENCES `parroquias` (`id_parroquia`) ON DELETE NO ACTION ON UPDATE NO ACTION;

--
-- Filtros para la tabla `casa_to_servicios`
--
ALTER TABLE `casa_to_servicios`
  ADD CONSTRAINT `casa_to_servicios_ibfk_1` FOREIGN KEY (`id_casa`) REFERENCES `casas` (`id_casa`) ON UPDATE CASCADE,
  ADD CONSTRAINT `casa_to_servicios_ibfk_2` FOREIGN KEY (`id_servicios`) REFERENCES `servicios` (`id_servicios`) ON UPDATE CASCADE;
...
--
ALTER TABLE `enfermedades`
  ADD CONSTRAINT `enfermedades_ibfk_1` FOREIGN KEY (`id_habitantes`) REFERENCES `habitantes` (`id_habitantes`) ON UPDATE CASCADE;

--
-- Filtros para la tabla `habitantes_to_casa`
--
ALTER TABLE `habitantes_to_casa`
  ADD CONSTRAINT `habitantes_to_casa_ibfk_1` FOREIGN KEY (`id_habitantes`) REFERENCES `habitantes` (`id_habitantes`) ON UPDATE CASCADE;

--
-- Filtros para la tabla `habitantes_to_nucleo_f`
--
ALTER TABLE `habitantes_to_nucleo_f`
  ADD CONSTRAINT `habitantes_to_nucleo_f_ibfk_1` FOREIGN KEY (`id_habitantes`) REFERENCES `habitantes` (`id_habitantes`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  ADD CONSTRAINT `habitantes_to_nucleo_f_ibfk_2` FOREIGN KEY (`nucleo_f`) REFERENCES `nucleo familiar` (`nucleo_f`) ON DELETE NO ACTION ON UPDATE NO ACTION;
...
ALTER TABLE `municipios`
  ...
  ADD CONSTRAINT `municipios_ibfk_2` FOREIGN KEY (`id_municipio`) REFERENCES `parroquias` (`id_parroquia`) ON DELETE NO ACTION ON UPDATE NO ACTION;

--
-- Filtros para la tabla `usuario_to_habitante`
--
ALTER TABLE `usuario_to_habitante`
  ADD CONSTRAINT `usuario_to_habitante_ibfk_1` FOREIGN KEY (`id_usuarios`) REFERENCES `usuarios` (`id_usuarios`) ON UPDATE CASCADE,
  ADD CONSTRAINT `usuario_to_habitante_ibfk_2` FOREIGN KEY (`id_habitantes`) REFERENCES `habitantes` (`id_habitantes`) ON UPDATE CASCADE,
  ADD CONSTRAINT `usuario_to_habitante_ibfk_3` FOREIGN KEY (`id_usuarios`) REFERENCES `usuarios` (`id_usuarios`) ON UPDATE CASCADE;
COMMIT;
